...
class Generator(nn.Module):
    ...
    def __init__(self, image_in_channels=3, edge_in_channels=2, out_channels=3, init_weights=True):
        ...
        # -----------------------
        # texture encoder-decoder 纹理编码解码
        # -----------------------
        ...
        # -------------------------
        # structure encoder-decoder 结构编码解码
        # -------------------------
